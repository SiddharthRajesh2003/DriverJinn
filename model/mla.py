...
class MemoryEfficientMultiLayerAttention(nn.Module):
    """
...
class MemoryEfficientMultiPathwayAggregator(nn.Module):
    """
...
class MemoryEfficientHybridAggregator(nn.Module):
    """
    Memory-efficient two-stage aggregation.
    ...
    def __init__(
        ...
        self.layer_aggregator = MemoryEfficientMultiLayerAttention(
        ...
        self.pathway_aggregator = MemoryEfficientMultiPathwayAggregator(
